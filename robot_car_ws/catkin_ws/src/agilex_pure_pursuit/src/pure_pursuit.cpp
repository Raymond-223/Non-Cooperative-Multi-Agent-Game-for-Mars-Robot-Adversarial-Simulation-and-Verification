...
PurePursuit::PurePursuit() {
    ...
    private_nh.param("scan_topic", scan_topic, std::string("scans"));
    ...
    private_nh.param("max_lin_vel", max_lin_vel_, 0.05);
    ...
    private_nh.param("look_ahead_dist", look_ahead_dist_, 0.3);
    ...
    if (loadTargetPath("/home/nvidia/docker_noetic/target_path.txt", path_msg)) {
        makePath(path_msg);
...
void PurePursuit::track() {
   ...
   std::cout<<"=========look_ahead_dist_=============="<<look_ahead_dist_<<std::endl;
